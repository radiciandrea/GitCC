...
if (file.exists("C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Codice/local.R")){
  ...
  folderOut = paste0("C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Dati/DRIAS",mod,"_sim_040a1")
} else {
  folderDrias = paste0("DRIAS",mod,"_elab")
  folderX0 = paste0("DRIAS",mod,"_sim")
  folderOut = paste0("DRIAS",mod,"_sim_040a1") 
}
...
for (year in years){
  ...
  saveRDS(SH, file = paste0(folderOut, "/040a_SH_Drias_SEIS_", name, "_", year, ".rds"))
