...
folderSim = paste0("C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Dati/DRIAS", mod, "_sim_060a")
folderPlot = paste0("C:/Users/2024ar003/Desktop/Alcuni file permanenti/Post_doc/Esperimenti/Outputs/Scenari climatici/DRIAS", mod, "_sim_060a")
...
E0m = matrix(NA, ncol = nIDs, nrow = length(files))
...
for(k in 1:nrow(scenariosDF)){
  ...
  filesAdults <- list.files(paste0(folderSim,"/"), paste0("030a_Adults_Drias_Hs99_pop", name))
...
for(i in 1:nrow(scenariosDF)){
  ...
  cat("name:", name, ", LTSR0>1: ", round(100*sum(LTSR0dengueMM[i,]>7, na.rm = T)/8981, 1), "\n")
