...
# to do that, we split years from July to December and then January to June and remove E0
...
for (year in years){
  ...
  saveRDS(A0v, file = paste0(folderOut, "/020e_A0_Drias_", name, "_", year, ".rds"))
